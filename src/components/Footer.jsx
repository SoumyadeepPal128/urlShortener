...
// --- Logo Component ---
// Included here for consistency and to make the component self-contained.
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
            <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                ...
                <div className="space-y-8 xl:col-span-1">
                    <div className="flex items-center space-x-3">
                        <Logo />
                        <span className="text-2xl font-bold text-gray-900 dark:text-white">URL Shortener</span>
                    </div>
                    <p className="text-gray-600 dark:text-gray-400 text-base">
                        Making the web a more connected place, one link at a time.
                    </p>
                    ...
                    <div className="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul className="mt-4 space-y-4">
                                <li><a href="#" className="text-base text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Shorten URL</a></li>
                                <li><a href="#" className="text-base text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">My URLs</a></li>
                                <li><a href="#" className="text-base text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Analytics</a></li>
                            </ul>
                        </div>
                        <div className="mt-12 md:mt-0">
                            ...
                            <ul className="mt-4 space-y-4">
                                ...
                                <li><a href="#" className="text-base text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Contact</a></li>
            ...
            <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8">
                <p className="text-base text-gray-500 dark:text-gray-400 xl:text-center">
                    &copy; 2025 MyApp, Inc. All rights reserved. <br />
                    Silcoorie Grant, Assam, India.
                </p>
            </div>
        </div>
    </footer>
